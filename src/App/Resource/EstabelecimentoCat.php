...
use App\Resource;
use App\Service\Estabelecimento as UserService;

class EstabelecimentoCat extends Resource {
    ...
    public function get($id = null) {
        if ($id === null) {
            $data = $this->getUserService()->getUsers($id);
        } else {
            $data = $this->getUserService()->getUsers($id);
        }
        if ($data === null) {
        ...
        $response = array('estabelecimentos' => $data);
